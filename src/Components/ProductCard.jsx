function ProductCard({ image, title, subtitle }) {
  return (
    <div className="group bg-white rounded-3xl shadow-md overflow-hidden w-full max-w-xs flex flex-col items-center border border-gray-200 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 cursor-pointer">
